...
/* =========================================================
   LIMPIEZA DE OBJETOS
   ========================================================= */
IF OBJECT_ID(N'dbo.sp_InsertarMovimiento', N'P') IS NOT NULL DROP PROCEDURE dbo.sp_InsertarMovimiento
GO
IF OBJECT_ID(N'dbo.sp_ListarMovimientos', N'P') IS NOT NULL DROP PROCEDURE dbo.sp_ListarMovimientos
GO
IF OBJECT_ID(N'dbo.sp_RegistrarIntentoBorrado', N'P') IS NOT NULL DROP PROCEDURE dbo.sp_RegistrarIntentoBorrado
GO
IF OBJECT_ID(N'dbo.sp_EliminarEmpleado', N'P') IS NOT NULL DROP PROCEDURE dbo.sp_EliminarEmpleado
GO
IF OBJECT_ID(N'dbo.sp_ActualizarEmpleado', N'P') IS NOT NULL DROP PROCEDURE dbo.sp_ActualizarEmpleado
GO
IF OBJECT_ID(N'dbo.sp_InsertarEmpleado', N'P') IS NOT NULL DROP PROCEDURE dbo.sp_InsertarEmpleado
GO
IF OBJECT_ID(N'dbo.sp_ObtenerEmpleado', N'P') IS NOT NULL DROP PROCEDURE dbo.sp_ObtenerEmpleado
GO
IF OBJECT_ID(N'dbo.sp_ListarEmpleados', N'P') IS NOT NULL DROP PROCEDURE dbo.sp_ListarEmpleados
GO
IF OBJECT_ID(N'dbo.sp_ListarTiposMovimiento', N'P') IS NOT NULL DROP PROCEDURE dbo.sp_ListarTiposMovimiento
GO
IF OBJECT_ID(N'dbo.sp_ListarPuestos', N'P') IS NOT NULL DROP PROCEDURE dbo.sp_ListarPuestos
GO
IF OBJECT_ID(N'dbo.sp_LogoutUsuario', N'P') IS NOT NULL DROP PROCEDURE dbo.sp_LogoutUsuario
GO
IF OBJECT_ID(N'dbo.sp_LoginUsuario', N'P') IS NOT NULL DROP PROCEDURE dbo.sp_LoginUsuario
GO
IF OBJECT_ID(N'dbo.sp_PuedeIntentarLogin', N'P') IS NOT NULL DROP PROCEDURE dbo.sp_PuedeIntentarLogin
GO
IF OBJECT_ID(N'dbo.sp_ObtenerError', N'P') IS NOT NULL DROP PROCEDURE dbo.sp_ObtenerError
GO

IF OBJECT_ID(N'dbo.Movimiento', N'U') IS NOT NULL DROP TABLE dbo.Movimiento
GO
IF OBJECT_ID(N'dbo.BitacoraEvento', N'U') IS NOT NULL DROP TABLE dbo.BitacoraEvento
GO
IF OBJECT_ID(N'dbo.Empleado', N'U') IS NOT NULL DROP TABLE dbo.Empleado
GO
IF OBJECT_ID(N'dbo.Puesto', N'U') IS NOT NULL DROP TABLE dbo.Puesto
GO
IF OBJECT_ID(N'dbo.TipoMovimiento', N'U') IS NOT NULL DROP TABLE dbo.TipoMovimiento
GO
IF OBJECT_ID(N'dbo.TipoEvento', N'U') IS NOT NULL DROP TABLE dbo.TipoEvento
GO
IF OBJECT_ID(N'dbo.Usuario', N'U') IS NOT NULL DROP TABLE dbo.Usuario
GO
IF OBJECT_ID(N'dbo.Error', N'U') IS NOT NULL DROP TABLE dbo.Error
GO
IF OBJECT_ID(N'dbo.DBErrors', N'U') IS NOT NULL DROP TABLE dbo.DBErrors
GO
